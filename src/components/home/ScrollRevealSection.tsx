  ...
  return (
    <section ref={containerRef} className="py-20 bg-gray-50 flex justify-center items-center overflow-hidden min-h-[70vh]">
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#04444c]/90 via-[#04444c]/40 to-transparent flex flex-col items-center justify-end text-center p-8 pb-20">
          <motion.div
          ...
          >
            The Ultimate <span className="text-[#fcc42c]">Solar Ecosystem</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Connect your solar panels, smart inverters, and battery storage into one unified, intelligent home energy network. Take control of your power.
          </motion.p>
        </div>
      </motion.div>
    </section>
