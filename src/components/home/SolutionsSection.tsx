...
export default function SolutionsSection() {
  ...
  return (
    <section className="py-10 bg-[#011a1e] relative overflow-hidden border-b border-white/10">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            >
              Which Solution <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#fcc42c] to-yellow-300">Do You Need</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0 }}
