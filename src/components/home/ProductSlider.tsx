...
export default function ProductSlider() {
  ...
  return (
    ...
    <section className="py-0 pt-8 sm:py-10 bg-[#011a1e] overflow-hidden relative border-t border-white/5">

      {/* Background glow */}
      <div className="absolute top-0 right-0 w-1/2 h-full bg-linear-to-l from-[#04444c]/20 to-transparent pointer-events-none" />

      <div className="container mx-auto px-4 lg:px-8 mb-8 sm:mb-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <div className="max-w-3xl">
            ...
            >
              Engineered for <span className="text-transparent bg-clip-text bg-linear-to-r from-[#fcc42c] to-yellow-200">Excellence</span>
            </motion.h2>
          ...
          {PRODUCTS?.map((product) => (
            ...
            >
              ...
              <div className="aspect-4/3 w-full rounded-2xl overflow-hidden mb-6 relative bg-black/20">
                ...
                <div className="absolute inset-0 bg-linear-to-t from-[#011a1e] via-[#011a1e]/20 to-transparent opacity-60" />
