...
export default function ProductFilterDropdown({ label, value, options, onChange, icon, disabled, loading, placeholder = "Select option", }: ProductFilterDropdownProps) {
  ...
  return (
    ...
    <div ref={wrapperRef} className="relative min-w-0">
      ...
      <button
        ...
        className={`group flex min-h-14 w-full items-center justify-between gap-3 rounded-lg border px-3.5 py-2.5 text-left transition-all ${isOpen
              ...
              {options?.map(option => {
                ...
                return (
                  ...
                  <button
                    ...
                    className={`flex w-full items-center justify-between gap-3 rounded-lg px-3 py-2.5 text-left transition-colors ${isSelected
                  ...
                  >
                    ...
                    <span className="min-w-0">
                      ...
                      {option?.description && (
                        <span className={`block truncate text-[11px] font-semibold ${isSelected ? "text-[#011a1e]/65" : "text-gray-500"
                          }`}>
                          {option?.description}
                        </span>
                      )}
