...
import ProductDetailSections from "./detail/ProductDetailSections"
import ProductDetailSummary from "./detail/ProductDetailSummary"
...
export default function ApiProductDetail({ product }: ApiProductDetailProps) {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#011a1e] pt-16 pb-10 text-white sm:pt-20 sm:pb-16">
